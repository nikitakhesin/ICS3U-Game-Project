...
def create_side_chain(length):
	...
	for i in range(random.randint(1, 2)):
		connect(side_chain_list[random.randint(0, len(side_chain_list) - 1)], side_chain_list[random.randint(0, len(side_chain_list) - 1)])
	connect(side_chain_list[random.randint(0, len(side_chain_list) - 1)], main_chain_list[random.randint(0, len(main_chain_list) - 1)])
